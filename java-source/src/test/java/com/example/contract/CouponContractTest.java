...
public class CouponContractTest {
    ...
    private static CouponState couponState = new CouponState(netmeds.getParty(), amazon.getParty(), amount, new UniqueIdentifier(), false, "ShivanSawant", couponName, empId, Instant.now(), false);
